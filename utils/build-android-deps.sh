...
wget https://www.openssl.org/source/openssl-1.0.2n.tar.gz -O /tmp/openssl.tar.gz
...
wget https://wiki.openssl.org/images/7/70/Setenv-android.sh -O /tmp/openssl/Setenv-android.sh
